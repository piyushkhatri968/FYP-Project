...
const AllRecruiters = ({ totalUsers, setTotalUsers, jobsCount }) => {
    ...
    >
      ...
      {filteredClients && filteredClients.length === 0 ? (
        <div className="text-center mt-4 text-lg font-medium">
          No Any Recruiters available.
        </div>
      ) : (
        <>
          <div className="overflow-auto">
            <h1 className="mb-2 text-2xl font-medium">Recruiters</h1>
              ...
              <tbody>
                {filteredClients?.map((user, index) => (
                  ...
                  >
                    ...
                    <td className="px-3 py-3">
                      {user?.recruiterDetails?.department || "N/A"}
                    </td>
                    <td className="px-3 py-3">
                      {user?.recruiterDetails?.companyName || "N/A"}
                    </td>
                    <td className="px-3 py-3">
                      {user?.recruiterDetails?.contactNumber || "N/A"}
                    </td>
                    <td className="px-3 py-3">
