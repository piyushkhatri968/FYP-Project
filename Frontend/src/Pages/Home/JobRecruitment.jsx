  ...
  return (
    <div className="max-w-[85vw] mx-auto my-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {/* First Card */}
        <div className="bg-[#FD1616] rounded-lg px-6 py-8 flex items-center gap-4">
          <div>
          ...
          <div>
            ...
            <Link
              to="find-job"
              className="text-white underline hover:text-[#010C29] hover:text-[17px] transition-all duration-500"
            >
              Apply Now &raquo;
            </Link>
          </div>
        ...
        {/* Second Card */}
        <div className="bg-[#010C29] rounded-lg px-6 py-8 flex items-center gap-4">
          <div>
