...
const Resume = () => {
  ...
  const getUserData = async () => {
    try {
      ...
      console.log(response.data.data.candidateDetails.position)
      setloading(false)
    } catch (error) {
      setloading(false)
      console.log(error)
        ...
        <div>
          <div className="rounded-lg shadow-xl mt-32">
            ...
            <div className="text-center">
              <img
                src={userData.profilePicture || defaultImage || currentUser.profilePicture}
                alt=""
              ...
              <p className="text-gray-500 text-lg mt-1">{userData.candidateDetails.position}</p>
              <a href={userData.candidateDetails.resume} target="_blank">Resume</a>
