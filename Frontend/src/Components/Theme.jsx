...
const Theme = (props) => {
  return (
    ...
    <div className="h-[60vh] sm:h-[75vh] bg-[#070e1f] bg-opacity-80 relative flex justify-center items-center text-white">
      <img
        src={props.heroImage}
        alt=""
        className="absolute top-0 -z-10 w-[100%] h-[60vh] sm:h-[75vh] object-cover mx-auto"
      />
      {/* Top Design */}
